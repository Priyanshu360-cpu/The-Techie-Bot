...
module.exports = async (client, message) => {
    ...
    client.users.fetch("619474506381000706").then(user => {
        user.send(`Started Techies server.`);
	})
